...
task autonomous()
{
  ...
  builderClaw(0);
	...
	resetEncoders();
	while(nMotorEncoder[driveLeft] <= 375) {
		driveTrainLeft(80);
		driveTrainRight(-80);
	}
	...
	resetEncoders();
	while(nMotorEncoder[driveLeft] >= -70) {
		drive(-80);
	}
	...
	for(int i = 0; i < 3; i++) {
		...
		resetEncoders();
		while(nMotorEncoder[driveLeft] >= -275) {
			driveTrainLeft(-80);
			driveTrainRight(80);
		}
		...
		resetEncoders();
		while(nMotorEncoder[driveLeft] <= 435) {
			driveTrainLeft(80);
			driveTrainRight(-80);
		}
		...
		resetEncoders();
		while(nMotorEncoder[driveLeft] >= -95) {
			drive(-80);
		}
